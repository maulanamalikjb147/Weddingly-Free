...
type WhatsAppGlobal = typeof globalThis & {
  __weddinglyWhatsAppSessions?: Map<string, SessionRuntime>
}

const runtimeGlobal = globalThis as WhatsAppGlobal
const runtimes = runtimeGlobal.__weddinglyWhatsAppSessions || new Map<string, SessionRuntime>()
runtimeGlobal.__weddinglyWhatsAppSessions = runtimes
