export default function WaveSeparator({ className = "w-full text-black bg-[#212529]" }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className={`w-full ${className} m-0 block`} preserveAspectRatio="none" style={{ height: '80px' }}>
